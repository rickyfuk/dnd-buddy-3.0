...
import charImageRender from '../CharacterImage/charImageRender.js';
...
function CharacterImage() {
	...
	useEffect(() => {
		const imgGender = localStorage.getItem('Gender');
		const imgClass = localStorage.getItem('Class');
		const imgRace = localStorage.getItem('Race');
		setImageInfo({
			imgGender: imgGender,
			imgClass: imgClass,
			imgRace: imgRace,
	...
	return <charImageRender imgInfo={imgInfo} />;
}
