...
function SavedCharacterImageThree() {

    const imgGender = localStorage.getItem('gender3');
    const imgClass = localStorage.getItem('charClass3');
    const imgRace = localStorage.getItem('race3');
...
export default SavedCharacterImageThree;