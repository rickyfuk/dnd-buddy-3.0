...
function SavedCharacterImageOne() {

    const imgGender = localStorage.getItem('gender1');
    const imgClass = localStorage.getItem('charClass1');
    const imgRace = localStorage.getItem('race1');
...
export default SavedCharacterImageOne;