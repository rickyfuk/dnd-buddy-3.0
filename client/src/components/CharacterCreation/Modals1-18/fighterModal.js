      ...
      <div className='modalCSS'>
        <Modal 
            ...
            <div>
                ...
                <Link to={'/create'}>
                <button className='btn btn-dark button1 revealButton' type='button' onClick={() => localStorage.setItem('Race', 'Dragonborn')}>            
                    Dragonborn
                </button>
                </Link>

                <Link to= {'/create'}>
                <button className='btn btn-dark revealButton' type='button' onClick={() => localStorage.setItem('Race', 'Half-Orc')}>
                    Half-Orc
                </button>
                </Link>
