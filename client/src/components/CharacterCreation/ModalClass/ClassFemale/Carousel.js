...
import portraitFemaleFighter from './assets/female-fighter-class.png';
import portraitFemaleWizard from './assets/female-wizard-class.png';
import portraitFemaleRogue from './assets/female-rogue-class.png';
import portraitFemaleCleric from './assets/female-cleric-class.png';
import portraitFemaleBard from './assets/female-bard-class.png';
import portraitFemaleRanger from './assets/female-ranger-class.png';
            ...
            <div>
                ...
                <div className='view-port' style={styles.view_port}>
                    <div ref={ref_id => this.card_container = ref_id} className='card-container portrait' style={styles.card_container}>
                        < Card card_number={portraitFemaleFighter} />
                        < Card card_number={portraitFemaleWizard} />
                        < Card card_number={portraitFemaleRogue} />
                        < Card card_number={portraitFemaleCleric} />
                        < Card card_number={portraitFemaleBard} />
                        < Card card_number={portraitFemaleRanger} />
                    </div>
                </div>
